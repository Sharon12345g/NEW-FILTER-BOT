...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001246549007').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1652683874').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002484234108') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filtebot:ashubhi@cluster0.q0e7s.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/ccac6a4899593b21d4973.jpg')
...
✨ ᴜᴘɪ ɪᴅ - <code>pg717293@oksbi</code>
ᴄʟɪᴄᴋ ᴛᴏ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ /myplan
...
SHORTLINK_API = environ.get('SHORTLINK_API', '754e27280d4e8c5bed3dd35ed84fc1630c993176')

# Others
MAX_B_TN = environ.get("MAX_B_TN", "5")
PORT = environ.get("PORT", "8080")
MSG_ALRT = environ.get('MSG_ALRT', 'Movies4U')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://favourite-claudia-movies4u1-e6eec36d.koyeb.app/")
