...
class script(object):
    START_TXT = """<b><blockquote>Hᴇʟʟᴏ {}, ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/Movies4usearch_bot>Movies4U</a></blockquote>

I ᴀᴍ ᴀ Tᴇʟᴇɢʀᴀᴍ Mᴏᴠɪᴇ Sᴇᴀʀᴄʜ BOT ʙʏ ᴛᴇᴀᴍ Mᴏᴠɪᴇs𝟺U, Jᴜsᴛ sᴇɴᴅ ᴍᴇ Mᴏᴠɪᴇ ɴᴀᴍᴇ ᴀɴᴅ Yᴇᴀʀ 😍</b>"""
...
‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/AshutoshGoswami24'>Movies4U</a> 
...
‣ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/{}>{}</a>
‣ ᴍʏ ʙᴇsᴛ ғʀɪᴇɴᴅ : <a href='tg://settings'>ᴛʜɪs ᴘᴇʀsᴏɴ</a> 
‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/M4upremium'>Asʜᴜᴛᴏsʜ Gᴏsᴡᴀᴍɪ 𝟸𝟺 🇮🇳</a> 
‣ ʟɪʙʀᴀʀʏ : <a href='https://docs.pyrogram.org/'>ᴘʏʀᴏɢʀᴀᴍ</a> 
‣ ʟᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.org/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 3</a> 
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : <a href='https://www.mongodb.com/'>ᴍᴏɴɢᴏ ᴅʙ</a> 
‣ ʙᴏᴛ sᴇʀᴠᴇʀ : <a href='https://heroku.com'>ʜᴇʀᴏᴋᴜ</a> 
...
ʀᴇғᴇʀᴀʟ ʟɪɴᴋ - https://telegram.me/{}?start=ASHU-{}
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/https://t.me/movies4u102/3)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
my features Stay here new features coming soon...  
 ...
 <b>✯ Join here : <a href=https://t.me/movies4uupdate>Join my updateds</a></b> 
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ FILTER-BOT బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই FILTER-BOT বট পরিচালনা করুন
